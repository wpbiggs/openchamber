...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.preview.actions.copyUrl': 'URL 복사',
  'contextPanel.preview.actions.openInAgentBrowser': '에이전트 브라우저에서 열기',
  'contextPanel.preview.actions.retry': '다시 시도',
  'contextPanel.preview.toast.noActiveSession': '에이전트 브라우저 액션을 사용하려면 채팅 세션을 여세요.',
  'contextPanel.preview.toast.missingModel': '에이전트에 보내기 전에 모델을 선택하세요.',
  'contextPanel.preview.toast.sentToAgent': '에이전트에게 전송했습니다.',
  'contextPanel.preview.toast.meteordroidNotConfigured': 'MeteorDroid가 설정되지 않았습니다. 설정 → MCP에서 추가해 에이전트 브라우저 도구를 활성화하세요.',
  'contextPanel.preview.agentMessage.visible': '에이전트 브라우저에서 이 URL을 열어 주세요: {url}',
  ...
  'contextPanel.preview.emptyState': 'URL을 입력하여 시작하세요.',
  'contextPanel.preview.empty': '미리보기 URL이 없습니다',
  'contextPanel.preview.urlPlaceholder': 'URL을 입력하세요…',
  'contextPanel.preview.urlAria': '미리보기 URL',
  ...
  'contextPanel.preview.picker.title': '미리볼 앱 선택',
  'contextPanel.preview.picker.description': 'dev 스크립트가 있는 여러 앱이 발견되었습니다. 시작할 앱을 선택하세요.',
  'contextPanel.preview.picker.cancel': '취소',
  ...
  'header.actions.openPreviewBrowser': '브라우저에서 미리보기 열기',
  'header.actions.openPreviewBrowserAria': '브라우저에서 미리보기 열기',
