...
export const dict: Record<I18nKey, string> = {
  ...
  "contextPanel.preview.actions.openInAgentBrowser": "Abrir en el navegador del agente",
  "contextPanel.preview.actions.retry": "Reintentar",
  "contextPanel.preview.toast.noActiveSession": "Abre una sesión de chat para usar acciones del navegador del agente.",
  "contextPanel.preview.toast.missingModel": "Selecciona un modelo antes de enviar al agente.",
  "contextPanel.preview.toast.sentToAgent": "Enviado al agente.",
  "contextPanel.preview.toast.meteordroidNotConfigured": "MeteorDroid no está configurado. Añádelo en Configuración → MCP para habilitar las herramientas del navegador del agente.",
  "contextPanel.preview.agentMessage.visible": "Abre esta URL en el navegador del agente: {url}",
  ...
  "contextPanel.preview.emptyState": "Introduce una URL para empezar.",
  "contextPanel.preview.empty": "Sin URL de vista previa",
  "contextPanel.preview.urlPlaceholder": "Introduce una URL…",
  "contextPanel.preview.urlAria": "URL de vista previa",
  ...
  "header.actions.openPreviewBrowser": "Abrir vista previa en el navegador",
  "header.actions.openPreviewBrowserAria": "Abrir vista previa en el navegador",
  ...
  "contextPanel.preview.picker.title": "Elige una app para previsualizar",
  "contextPanel.preview.picker.description": "Se encontraron varias apps con un script dev. Elige una para iniciar.",
