...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.preview.actions.copyUrl': '复制 URL',
  'contextPanel.preview.actions.openInAgentBrowser': '在代理浏览器中打开',
  'contextPanel.preview.actions.retry': '重试',
  'contextPanel.preview.toast.noActiveSession': '打开一个聊天会话后才能使用代理浏览器操作。',
  'contextPanel.preview.toast.missingModel': '发送给代理之前请先选择模型。',
  'contextPanel.preview.toast.sentToAgent': '已发送给代理。',
  'contextPanel.preview.toast.meteordroidNotConfigured': 'MeteorDroid 尚未配置。请在 设置 → MCP 中添加它以启用代理浏览器工具。',
  'contextPanel.preview.agentMessage.visible': '在代理浏览器中打开此 URL：{url}',
  ...
  'contextPanel.preview.emptyState': '输入 URL 以开始。',
  'contextPanel.preview.empty': '没有预览 URL',
  'contextPanel.preview.urlPlaceholder': '输入 URL…',
  'contextPanel.preview.urlAria': '预览 URL',
  ...
  'header.actions.openPreviewBrowser': '在浏览器中打开预览',
  'header.actions.openPreviewBrowserAria': '在浏览器中打开预览',
  ...
  'contextPanel.preview.picker.title': '选择要预览的应用',
  'contextPanel.preview.picker.description': '发现多个带有 dev 脚本的应用。请选择一个启动。',
  'contextPanel.preview.picker.cancel': '取消',
