...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "contextPanel.preview.actions.copyUrl": "Copiar URL",
  "contextPanel.preview.actions.openInAgentBrowser": "Abrir no navegador do agente",
  "contextPanel.preview.actions.retry": "Tentar novamente",
  "contextPanel.preview.toast.noActiveSession": "Abra uma sessão de chat para usar ações do navegador do agente.",
  "contextPanel.preview.toast.missingModel": "Selecione um modelo antes de enviar para o agente.",
  "contextPanel.preview.toast.sentToAgent": "Enviado ao agente.",
  "contextPanel.preview.toast.meteordroidNotConfigured": "O MeteorDroid não está configurado. Adicione em Configurações → MCP para habilitar as ferramentas do navegador do agente.",
  "contextPanel.preview.agentMessage.visible": "Abra esta URL no navegador do agente: {url}",
  "contextPanel.preview.agentMessage.instructions": "Use MeteorDroid browser tools to open the URL: {url}. Call browser_open_url({\"url\":\"{url}\"}). If the server pauses for a sensitive step, call browser_request_human and wait for the user to say \"resume\", then call browser_resume and continue.",
  "contextPanel.preview.iframeTitle": "Prévia",
  "contextPanel.preview.invalidUrl": "A prévia precisa de uma URL http(s) válida.",
  "contextPanel.preview.emptyState": "Digite uma URL para começar.",
  "contextPanel.preview.empty": "Sem URL de prévia",
  "contextPanel.preview.urlPlaceholder": "Digite uma URL…",
  "contextPanel.preview.urlAria": "URL de visualização",
  ...
  "header.actions.openPreviewBrowser": "Abrir visualização no navegador",
  "header.actions.openPreviewBrowserAria": "Abrir visualização no navegador",
  ...
  "contextPanel.preview.description": "Inicie um servidor de desenvolvimento para visualizar seu projeto no navegador.",
  ...
  "contextPanel.preview.picker.title": "Escolha um app para pré-visualizar",
  "contextPanel.preview.picker.description": "Foram encontrados vários apps com um script dev. Escolha um para iniciar.",
  "contextPanel.preview.picker.cancel": "Cancelar",
